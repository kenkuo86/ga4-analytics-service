...
gcloud run deploy "$SERVICE" \
  ...
  --update-env-vars="BIGQUERY_BILLING_PROJECT=${PROJECT_ID},GA4_QUERY_MAX_DAYS=90,GA4_QUERY_EARLIEST_DATE=2020-10-14,GA4_QUERY_MAX_BYTES_PER_JOB=2000000000,GA4_QUERY_MAX_BYTES_PER_REQUEST=10000000000,GA4_QUERY_JOB_TIMEOUT_MS=60000,GA4_QUERY_TIME_ZONE=Asia/Taipei" \
